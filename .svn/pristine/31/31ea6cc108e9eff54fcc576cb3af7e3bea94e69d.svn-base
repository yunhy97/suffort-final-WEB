	...
	<div class="body" style="margin-top: 72px;">
		<div class="row">
			...
			<div class="col-10" id="content-div">
				...
				<form id="form-new-board" method="post" action="userBoardModify.do" >
				<input type="hidden" value="${boardDto.userBoardNo }" name="userBoardNo">
					<div id="tag-box">
					</div>
					<div class="row">
						...
						<div class="col-12 d-flex justify-content-center">
							<div class="input-group mb-3" style="width: 1300px;">
			                	<div class="input-group-prepend" >
			                  	...
			                  	<input type="text" class="form-control" id="board-git" name="userBoardGit" value="${boardDto.userBoardGit }">              
			                </div>
			            </div>
						...
						<div class="col-12 d-flex justify-content-center">
							<div class="input-group mb-3" style="width: 1300px;">
			                	<div class="input-group-prepend" >
			                  	...
			                  	<input type="text" class="form-control" id="userboard-tag" disabled="disabled" value="${boardDto.tagsText }">              
			                </div>
			            </div>
					</div>
					<div class="row">
						<div class="col-12 d-flex justify-content-center">
							<div class="input-group mb-3" style="width: 1300px;">
							  ...
							  <input type="text" class="form-control" name="userBoardAccess" id="access-content" value="${boardDto.userBoardAccess }" readonly>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-12 d-flex justify-content-center">
							<div class="input-group mb-3" style="width: 1300px;">
			                	<div class="input-group-prepend" >
			                  	...
			                  	<input type="text" class="form-control" id="board-title" name="userBoardTitle" value="${boardDto.userBoardTitle }">               
			                </div>
			            </div>
					...
					<div class="row justify-content-md-center">
						<div class="col_c" style="margin-bottom: 30px">
			                <div class="input-group">                 
			                  <textarea id="ckeditor" name="userBoardContent" >${boardDto.userBoardContent }</textarea> 
			                </div>
			            </div> 
	      ...
	      <div class="modal-body">
	      	<c:forEach var="category" items="${categories }">
		        ...
		        <div class="custom-control custom-checkbox mb-3" >
			    	<input name="chk" value="${tag.tagNo }" data-tag-no="${tag.tagNo }" data-tag-name="${tag.tagName }" type="checkbox" class="custom-control-input" id="tag-${tag.tagNo }" required="required" ${boardDto.isExistTag(tag.tagNo) ? 'checked' : '' }><!-- 체크박스 제한은 jquery에서 -->
